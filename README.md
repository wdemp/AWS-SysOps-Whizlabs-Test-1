...
My Answer: Store application password in encrypted S3 Bucket & retrieve while deploying.
Real Answer: Use System Parameter Store to store application password.
